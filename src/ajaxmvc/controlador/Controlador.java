...
public class Controlador extends HttpServlet {
	...
	*/
	 ...
	 * @uml.property  name="ext3ds"
	 */
  private DataSource ext3ds;
	/**
	...
	// del servlet a nivel de contenedor web.
	    ...
	    try {
	    	...
	    	setExt3ds((DataSource) contexto.lookup(sc.getInitParameter("ds")));
	    	if (getExt3ds()==null)
	    		System.out.println("ext3ds es null.");
	    	// El datasource se almacena a nivel de aplicaciï¿½n.
	    	sc.setAttribute("ext3ds", getExt3ds());
 ...
 */
	public void setExt3ds(DataSource ext3ds) {
		this.ext3ds = ext3ds;
	}
