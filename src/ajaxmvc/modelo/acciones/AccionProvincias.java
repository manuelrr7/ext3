...
import ajaxmvc.modelo.beans.Provincia;
 ...
 * @version  Ajax-MVC2
 */
public class AccionProvincias implements Accion {
	/**
	...
	public boolean ejecutar(HttpServletRequest request,
		...
		if (procesaBD.getProvincias() != null){		
			
		
			
		}else{
			provincia.setError("Error al cargar las provincias");
		}
		json = new Gson().toJson(procesaBD.getProvincias());
