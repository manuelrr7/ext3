 ...
 * @version  Ajax-MVC2
 */
public class AccionBorrarCliente implements Accion {
	/**
	...
	public boolean ejecutar(HttpServletRequest request,
		...
		if (procesaBD.eliminaCliente(cod)){		
			
		
			
		}else{
			cliente.setError("Error al cargar los datos cliente");
		}
		json = new Gson().toJson(procesaBD.eliminaCliente(cod));
